 ...
 * @author Anthony
 * 
 * Based off of code from https://github.com/warmwaffles/Noise
 */
public class PerlinNoise {
     ...
     * @param octaves
     */
    public PerlinNoise(int seed, double persistence, double frequency, int octaves) {
        
            set(seed, persistence, frequency, octaves);
    ...
    *
        * @param x
        * @param y
        * @return The height of the (x,y) coordinates 
    ...
    */
     ...
     */
    public final void set(int seed, double persistence, double frequency, int octaves) {
